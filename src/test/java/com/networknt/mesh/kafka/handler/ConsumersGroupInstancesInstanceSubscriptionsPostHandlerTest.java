...
public class ConsumersGroupInstancesInstanceSubscriptionsPostHandlerTest {
    ...
    @Test
    public void testConsumersGroupInstancesInstanceSubscriptionsPostHandlerTest() throws ClientException {

        final Http2Client client = Http2Client.getInstance();
        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/consumers/TikEZIiwWxntRaBgDYft/instances/TikEZIiwWxntRaBgDYft/subscriptions";
