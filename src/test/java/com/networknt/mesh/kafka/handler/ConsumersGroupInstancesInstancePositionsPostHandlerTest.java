...
@Ignore
public class ConsumersGroupInstancesInstancePositionsPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstancePositionsPostHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstancePositionsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/consumers/lSpDszbxTODjbAN/instances/lSpDszbxTODjbAN/positions";
