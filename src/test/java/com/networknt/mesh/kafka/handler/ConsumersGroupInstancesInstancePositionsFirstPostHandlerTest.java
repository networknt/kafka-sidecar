...
@Ignore
public class ConsumersGroupInstancesInstancePositionsFirstPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstancePositionsFirstPostHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstancePositionsFirstPostHandlerTest() throws ClientException {

        final Http2Client client = Http2Client.getInstance();
        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/consumers/HCVMgsGdnWtXovHRrZ/instances/HCVMgsGdnWtXovHRrZ/positions/first";
