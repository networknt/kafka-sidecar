...
@Ignore
public class ConsumersGroupInstancesInstanceSubscriptionsDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceSubscriptionsDeleteHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceSubscriptionsDeleteHandlerTest() throws ClientException {
