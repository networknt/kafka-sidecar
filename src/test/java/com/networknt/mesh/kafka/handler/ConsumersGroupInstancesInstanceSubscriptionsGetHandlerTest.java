...
@Ignore
public class ConsumersGroupInstancesInstanceSubscriptionsGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceSubscriptionsGetHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceSubscriptionsGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/consumers/VPLakJVrG/instances/VPLakJVrG/subscriptions";
