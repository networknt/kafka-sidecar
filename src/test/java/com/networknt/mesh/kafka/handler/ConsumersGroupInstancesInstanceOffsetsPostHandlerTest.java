...
@Ignore
public class ConsumersGroupInstancesInstanceOffsetsPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceOffsetsPostHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceOffsetsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/consumers/vxvkpZfNjnWhCwRaAe/instances/vxvkpZfNjnWhCwRaAe/offsets";
