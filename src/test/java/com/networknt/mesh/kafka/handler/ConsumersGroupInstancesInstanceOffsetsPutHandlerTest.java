...
@Ignore
public class ConsumersGroupInstancesInstanceOffsetsPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceOffsetsPutHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceOffsetsPutHandlerTest() throws ClientException {
