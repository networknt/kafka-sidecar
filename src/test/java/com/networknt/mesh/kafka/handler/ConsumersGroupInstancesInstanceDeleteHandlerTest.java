...
@Ignore
public class ConsumersGroupInstancesInstanceDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceDeleteHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/consumers/vtmlFxRvRobfdFpdPWFCrRI/instances/vtmlFxRvRobfdFpdPWFCrRI";
