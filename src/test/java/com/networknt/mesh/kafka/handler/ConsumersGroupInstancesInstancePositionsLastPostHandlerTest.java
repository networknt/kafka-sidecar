...
@Ignore
public class ConsumersGroupInstancesInstancePositionsLastPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstancePositionsLastPostHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstancePositionsLastPostHandlerTest() throws ClientException {

        final Http2Client client = Http2Client.getInstance();
        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/consumers/sZrTr/instances/sZrTr/positions/last";
