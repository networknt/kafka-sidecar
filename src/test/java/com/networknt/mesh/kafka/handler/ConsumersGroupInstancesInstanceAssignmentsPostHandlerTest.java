...
@Ignore
public class ConsumersGroupInstancesInstanceAssignmentsPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceAssignmentsPostHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceAssignmentsPostHandlerTest() throws ClientException {

        final Http2Client client = Http2Client.getInstance();
        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/consumers/onPItCeMly/instances/onPItCeMly/assignments";
