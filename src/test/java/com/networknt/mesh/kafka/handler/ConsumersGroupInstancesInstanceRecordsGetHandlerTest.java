...
@Ignore
public class ConsumersGroupInstancesInstanceRecordsGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumersGroupInstancesInstanceRecordsGetHandlerTest.class);
    ...
    @Test
    public void testConsumersGroupInstancesInstanceRecordsGetHandlerTest() throws ClientException {

        final Http2Client client = Http2Client.getInstance();
        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/consumers/cVJoLrLIr/instances/cVJoLrLIr/records?timeout=78&max_bytes=62";
